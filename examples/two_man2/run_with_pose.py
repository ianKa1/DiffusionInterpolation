...
# Prompts for person/character
prompt = 'person, character, portrait, action pose, high quality, detailed, cinematic'
n_prompt = 'blurry, low quality, distorted, ugly, watermark, text, multiple people, crowd'
...
results = interpolator.interpolate_qc(
    ...
    optimize_cond=200,      # Textual inversion for quality
